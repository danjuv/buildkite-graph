...
async function walkEntity<T extends Entity>(entity: T, nodeCache: Map<any, any>, mutator?: (entity: Entity) => any): Promise<T> {
...
export async function walk(p: Pipeline, mutator: (entity: Entity) => Entity): Promise<Pipeline> {
